<?php
 if (!isset($_SESSION)){
   ...
   // };
    ...
    header("location:../../views/reply/reply_other.php?message=del&pti=".$_GET['pti']."&bi=".$_GET['bi']."&BOM=".$_GET['BOM']."&d=".$_GET['d']."&pna=".$_GET['pna']."&ProcessNo=".$_GET['pn']."&MakerId=".$_GET['mi']."&sqty=".$_GET['s']."&C=".$_GET['C']."");
