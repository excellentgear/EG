    ...
    <div class="m-box" style="width:820px;">
        ...
        <div class="m-bd help-doc">
            ...
            <ul>
                ...
                <li><b>決策者會收到通知</b>：品管確認說明完成、或人工開單時指定／換了「決策者」欄位，若這張單當下剛好就是「待決策」（沒有未回覆的徵詢、也還沒勾處置方式），系統會自動通知該決策者送出決策；清單與本頁上方狀態列「待決策」後面括號會顯示決策者的部門與姓名（只設了範圍時列出目前範圍內在職的每一位）。沒有指定決策者（或範圍內查無在職人員）時不會加註也不會發通知。</li>
