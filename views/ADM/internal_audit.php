...
<div class="ia-mask" id="helpUseMask"><div class="ia-modal">
    ...
    <div class="ia-mbody help-doc">
        ...
        <ul>
            ...
            <li><b>績效沒達成開的是「異常矯正處理單」不是 IA 單</b>：紙本備註欄本來就印矯正單編號。按「開矯正單」會自動帶出年度、哪幾個月沒達成、當時的數值與 KPI 目標，並附上「請說明原因及確認是否需要調整KPI目標?」，責任單位＝該指標的部門、回覆人＝擔當者；開完單號自動寫回備註欄。<b>開立人一律是這張查檢表的「稽核人」，不是按下按鈕的人</b>（管理員代按也一樣），受稽單位收到通知才看得出是誰稽核出來的；查檢表沒填稽核人時才退回操作者。</li>
