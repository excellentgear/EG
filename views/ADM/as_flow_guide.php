...
$ISSUES = [
    ...
    ['中','資材課(倉管組)','3-SM-01 §7.1（第 1/3 頁）','此文件有兩份「使用表單」清單且內容不同。第 1/3 頁寫「出貨標籤(2-WH-01-07)」→ 錯，2-WH-01-07 是入庫單，出貨標籤應為 2-WH-01-03（DB、實體檔名、2-WH-01 §9.11 三方一致）。第 3/3 頁寫「出貨單(2-WH-01-04)、製程管制卡(2-QA-01-02)」→ 正確。※ 查證請翻到第 1 頁，第 3 頁沒問題','第 1/3 頁編號改為 (2-WH-01-03)，並把兩處清單統一成一份'],
