...
<div class="modal fade" id="helpUseMask" tabindex="-1"><div class="modal-dialog" style="width:720px;"><div class="modal-content">
  ...
  <div class="modal-body help-doc" style="font-size:13px;max-height:70vh;overflow:auto;">
    ...
    <ul>
      ...
      <li>與「員工資料管理」連動（2026-09-24）：①此人離職成立（實際或預定離職日到期）當下，名下所有使用中的圖章會<b>自動作廢</b>，作廢日＝離職日 ②此人部門／職位異動導致原掛的部門人員章不再合時宜時，員工資料管理頁存檔後會提示並提供連結過來（<b>不會自動改動或停用</b>，要人判斷後手動處理）③新增員工存檔後會提示順手來這裡登記圖章。</li>
      <li><b>在職狀態為「特殊帳號」或「最高權限帳號」者，不可為其登記圖章</b>（這兩種帳號不代表一個實際簽章的人），新增登記與批次建立的人員候選都會排除，直打 API 也會被擋下。</li>
    </ul>
...
// 由員工管理頁的離職／部門異動／新進提醒帶連結過來時，直接預填持有人姓名篩選（2026-09-24）
(function(){
  try{
