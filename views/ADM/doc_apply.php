...
<div class="da-mask" id="setMask"><div class="da-modal mid">
    ...
    <div class="m-body">
        ...
        <div class="sec">
            ...
            <div class="da-hint">預設：核准＝最高決策者、管理代表＝管理課主管、單位主管＝申請單位的主管、申請人＝填表人。
                實際人員一律即時查組織角色綁定，不寫死人名。<br>
                <b>單位主管的追溯規則（ai-rules/24 審核層級規範，全站一致）</b>：先取申請單位的最高主管；
                申請人自己就是該單位最高主管時（例：品管組組長開單）自動往上一層單位取（＝品管課課長），
                <b>但最多只追溯到「課」級</b>——課級單位的最高主管本人開單時，單位主管從缺、由申請人自己簽，
                不會再往上追到廠長或總經理。</div>
        </div>
        <div class="sec">
            <h5>圖章模板</h5>
...
<div class="da-mask" id="helpUseMask"><div class="da-modal">
    ...
    <div class="m-body help-doc">
        ...
        <ul>
            ...
            <li><b>「單位主管」欄會自動往上一層單位追溯</b>（ai-rules/24 審核層級規範）：申請人自己就是本單位最高主管時
                （例：品管組組長開單），單位主管改蓋<b>上一層單位的主管</b>（＝品管課課長）；
                <b>只追溯到「課」級為止</b>——課級單位的最高主管本人開單時，單位主管從缺、<b>一樣蓋他自己的章</b>
                （不做權責迴避、也不留白），不會往上追到廠長或總經理。</li>
