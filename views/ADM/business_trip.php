...
<div class="bt-mask" id="setMask"><div class="bt-modal">
    ...
    <div class="m-body">
        ...
        <div class="bt-hint" style="margin-top:4px;">選「留白」列印時空白，供紙本手蓋；選項的實際人員都是當下查組織角色綁定得出，不寫死人名。
            <b>課級單位的最高主管本人公出時</b>核准人才會改成最高核准人員，選「實際核准的單位主管」時該格就會蓋到總經理的章
            （比照紙本附註）；<b>組長公出則是往上一層單位取（＝該課的課長）核准</b>，不會直接跳到總經理（ai-rules/24 審核層級規範）；
...
<div class="bt-mask" id="helpUseMask"><div class="bt-modal">
    ...
    <div class="m-body help-doc">
        ...
        ④主管在通知或本頁<b>「待我核准」</b>分頁核准／退回（<b>退回一定要填原因</b>）。
        　　核准人＝<b>公出人所屬單位的主管</b>；公出人自己就是本單位最高主管時（例：組長）自動往上一層單位取（＝該課的課長），
        　　<b>只追溯到「課」級</b>，課級最高主管本人公出才改由最高核准人員核准（ai-rules/24 審核層級規範）。<br>
