            ...
            <div class="right_col" role="main">
                <div class="">
                    ...
                    <div class="page-title">
                        <button id="btnPageHelp" class="page-help-btn" style="float:right;margin:6px 0 0 8px;"><i class="fa fa-question-circle"></i> 使用說明</button>
...
$PAGE_HELP_TITLE = 'QC 待驗清單 使用說明';
$PAGE_HELP_BODY  = <<<'HTMLHELP'
<p>本頁是<b>品管的待驗清單</b>：生管發包／廠內開工後，需要檢驗的製程會自動出現在這裡，檢驗完按【完成】結案。上方可切到 <b>QC完工紀錄</b> 查已完成的。</p>

<h4>一、清單怎麼看</h4>
<ul>
    <li><b>狀態</b>（燈號）：<b>待驗</b>＝還沒有任何檢驗結果、<b>異常</b>＝報工時判為異常(QQ)、<b>允收</b>＝報工判為允收(ok)。</li>
    <li><b>報工進度徽章</b>：顯示這個製程「已經報了多少數量」，例「已驗滿·待按完成」「已驗 130/1500」「後站已開工·滾齒」。<b>這是純顯示，不會自動改任何資料。</b></li>
    <li>容器、樣品、治具等欄位來自生管填的資料，這裡只顯示。</li>
</ul>

<h4>二、最容易誤會的一件事：報工 ≠ 完工</h4>
<div class="tip">
    <b>「報工」與「完工」是兩件事。</b>報工（判異常／允收）<b>永遠不會自動完工</b>；
    只有按下該列的【<b>完成</b>】按鈕才會寫入完工，那一刻這筆才會從待驗清單移走、並出現在「QC完工紀錄」。
    <br>所以會出現「明明已經報工了，清單上還掛著、完工紀錄也查不到」——那就是<b>還沒有人按完成</b>。
    <br>系統<b>刻意不做自動完工</b>：分批出的站會在最後一批報完的當下被自動關掉，品管就少了最後確認那一關。
</div>

<h4>三、篩選與搜尋</h4>
<ul>
    <li><b>狀態</b>：全部／待驗／異常／允收。</li>
    <li><b>報工</b>：三顆按鈕可單獨挑出「已驗滿·只差按完成」「已驗部分」「後站已開工」的製程——
        這三種都是「其實現場已經做完或做過頭、只差品管按完成」的情況。</li>
    <li><b>製程</b>下拉、右上<b>搜尋框</b>（BOM／料號／客戶／廠商／製程）可一起使用。</li>
    <li>按<b>清除所有篩選</b>回到全部。</li>
</ul>

<h4>四、一鍵完成</h4>
<ul>
    <li>工具列的【<b>一鍵完成</b>】會把「<b>報工已驗滿、只差沒人按完成</b>」的整批標記為完成。</li>
    <li>按下的當下才會向後端要<b>最新</b>的清單（避免別人剛改過、您按到舊資料＝點開即刷新），
        而且是以<b>目前篩選條件下的全部資料</b>為準，<b>不是只有畫面上這一頁</b>。</li>
    <li>逐筆送出，完成後會回報成功／失敗筆數；失敗的維持原狀，可再處理。</li>
</ul>

<h4>五、QC完工紀錄</h4>
<ul>
    <li>右上【<b>QC完工紀錄</b>】開側邊抽屜，預設只列<b>真的按過完成</b>的紀錄（與紙本一致）。</li>
    <li>勾選「<b>含未完工的報工</b>」才會把「已報工但還沒按完成」的一起列出來，方便對帳；<b>預設不勾＝完全維持原本的畫面</b>。</li>
    <li>可搜尋與分頁；勾選時的排序會改用「完工時間，沒有就用最後報工時間」。</li>
</ul>

<h4>六、新增與統計</h4>
<ul>
    <li>【<b>新增</b>】：現場臨時要驗、清單上沒有的項目可自行建一筆。</li>
    <li>【<b>統計</b>】：依製程／廠商等維度看檢驗狀況。</li>
</ul>

<h4>七、權限</h4>
<ul>
    <li>能看到這一頁＝有品管相關模組權限；報工、完成、新增等寫入動作後端會再驗一次權限。</li>
    <li>選單顯示與權限設定在<b>系統設定 → 使用者權限設定</b>。</li>
</ul>
HTMLHELP;
