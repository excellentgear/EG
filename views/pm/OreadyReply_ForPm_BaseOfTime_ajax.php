<?php
// OreadyReply_ForPm_BaseOfTime_ajax.php
// 由 OreadyReply_ForPm_BaseOfTime.php include，請勿直接開啟。
...
// AJAX GET BOM FILES HANDLER
    ...
    $scan_dir = eg_bom_scan_dir_auto(); // 實體路徑
    $url_dir = '/nas/';    // 網頁讀取路徑
...
// ── 儲存PTI篩選按鈕設定 ────────────────────────────────────────────────────
    ...
    try {
        ...
        $sql = "INSERT INTO system_parameters (param_group, param_key, param_value, description, updated_by, updated_at)
                VALUES ('OreadyReply_PM', 'pti_filter_buttons', :val, 'OreadyReply_ForPm_BaseOfTime.php 頁面 - PTI製程分類篩選按鈕顯示設定，儲存已選取的 process_type_id 清單', :uid, NOW())
