...
// ══════════════════════════════════════════════════════════════════════
// AJAX 請求統一分派到 OreadyReply_ForPm_BaseOfTime_ajax.php
...
if (isset($_POST['action'])) {
    require __DIR__ . '/OreadyReply_ForPm_BaseOfTime_ajax.php';
    exit;
}
...
// 接著再加上 BOM 備註
    ...
    window.markSkipBomIng = function(bomIngFid, bomOfEditedItem, bomSnOfEditedItem, processName, reason) {
        ...
        var _skipUrl = window.location.pathname.split('/').pop() || 'OreadyReply_ForPm_BaseOfTime.php';
        $.ajax({
            url: _skipUrl,
            type: 'POST',
            data: {
