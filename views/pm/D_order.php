                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_title">
                                <?php if ($d_id ==""){ ?>
                                        <h2>產品製程順序設定 <small>請先點選設定</small></h2>
                                <?php } else { ?>
                                        <h2><?= $D_Setting_Id ?> <small><?= $Drawing_No ?></small></h2>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="../../src/store/_updateD_order.php?d_id=<?= $D_Setting_list['d_id'] ?>">
                                                <input type="button" name="updateDrawing" class="btn btn-warning btn-xs update" value="設定"></a></td>
                                        </tr>
                                    <?php }
                                    ?>
                                </tbody>
