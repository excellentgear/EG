    ...
    <div class="m-body help-doc">
        ...
        <ul>
            ...
            <li><b>報工紀錄</b>（唯讀）：同一張製令同一道製程的多筆報工<b>合併成一列</b>顯示，依日期由新到舊；
                <b>架機／加工的日期時間另外獨立成下方一張表格</b>（欄位太擠會看不清楚）——<b>架</b>是架機的日期時間區間，
                <b>加</b>是加工的日期時間區間，時間下方一併標出人員；只有一筆就直接印時間，<b>同一天筆數不多會合併成
                一個時間區間，筆數太多或跨日則改印日期區間＋共幾筆</b>（時間跨日時兩端各自印出日期，不會誤讀成同一天），
                人員也是同樣道理，多人只印「N 人」不逐一列名。
