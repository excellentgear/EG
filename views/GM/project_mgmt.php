    ...
    <div class="m-body help-doc">
        ...
        <ul>
            ...
            <li><b>報工紀錄</b>（唯讀）：同一張製令同一道製程的多筆報工<b>合併成一列</b>顯示，依日期由新到舊。
                <b>廠內製程</b>「架機／加工時間」欄分兩行列出——<b>架</b>是架機的日期時間區間，<b>加</b>是加工的日期時間區間；
                只有一筆就直接印時間，<b>同一天筆數不多會合併成一個時間區間，筆數太多或跨日則改印日期區間＋共幾筆</b>
                （時間會跨日時兩端各自印出日期，不會誤讀成同一天）；人員也是同樣道理，多人只印「N 人」不逐一列名。
                <b>委外製程</b>沒有架機/加工的概念，列的仍是逐筆轉出入紀錄（轉出入日期、廠商去向、數量、損耗）。
