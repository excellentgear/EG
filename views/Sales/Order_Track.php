                                                        ...
                                                        <div class="x_content">
                                                            ...
                                                            <form action="../../src/store/_updateQC_id.php" method="POST" action="" class="form-horizontal form-label-left" novalidate>
                                                                <div>
                                                                    ...
                                                                    <?php if($QC_TOTAL==""){ ?>
                                                                        <div class="item form-group">
                                                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="eventdate">公告日期 <span class="required">*</span>
                                                                            </label>
                                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                                <div class="datetest">
                                                                                    <input type="text" id="datepicker" value="<?= $eventdate ?>" name='eventdate'>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                                                    
                                                                        <div class="item form-group">
                                                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="enddate">結束日期 <span class="required">*</span>
                                                                            </label>
                                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                                <div class="datetest">
                                                                                    <input type="text" id="datepicker_end" value="<?= $enddate ?>" name='enddate'>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="item form-group">
